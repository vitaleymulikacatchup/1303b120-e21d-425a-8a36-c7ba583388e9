...
export const metadata: Metadata = {
  title: "TOYSTORY - Where Every Toy Tells a Story | Premium Children's Toys",
  description: "Discover magical toys that spark imagination and creativity. Shop our curated collection of safe, educational toys for children of all ages at TOYSTORY.",
  keywords: "toys, children toys, educational toys, safe toys, kids toys, toy store, building blocks, stuffed animals, action figures, dolls",
  metadataBase: new URL("https://toystory.com"),
  alternates: {
    canonical: "https://toystory.com"
  },
  openGraph: {
    title: "TOYSTORY - Premium Children's Toys",
    description: "Discover magical toys that spark imagination and creativity for children of all ages.",
    url: "https://toystory.com",
    siteName: "TOYSTORY",
    images: [{
      url: "https://images.pexels.com/photos/3806754/pexels-photo-3806754.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
  ...
  twitter: {
    ...
    title: "TOYSTORY - Where Every Toy Tells a Story",
    description: "Discover magical toys that spark imagination and creativity for children of all ages.",
    images: ["https://images.pexels.com/photos/3806754/pexels-photo-3806754.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
